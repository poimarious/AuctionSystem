...
public class PlaceBidTest {
    ...
    @Test
    void PlaceBidWhenAuctionIsClosingTest() throws InvalidBidException, AuctionClosedException {
    ...
    @Test
    void PlaceBidWhenAuctionIsOpeningTest() throws InvalidBidException, AuctionClosedException {
    ...
    @Test
    void TooLowPlaceBidTest() throws InvalidBidException, AuctionClosedException {
    ...
    @Test
    void ObserverTest() throws InvalidBidException, AuctionClosedException {
