...
public class SellerController {
  ...
  public void handleAddNewProduct(ActionEvent event) {
    SceneManager.getInstance().switchScene("/org.deptrai.auctionsystem.views/add-product-view.fxml", "Đăng sản phẩm mới");
  }

  @FXML
  public void handleOpenInventory(ActionEvent event) {
    SceneManager.getInstance().switchScene("/org.deptrai.auctionsystem.views/inventory-view.fxml", "Kho hàng của tôi");
  }

  @FXML
  public void handleShowProfile(ActionEvent event) {
    SceneManager.getInstance().switchScene("/org.deptrai.auctionsystem.views/profile-view.fxml", "Hồ sơ cá nhân");
  }
